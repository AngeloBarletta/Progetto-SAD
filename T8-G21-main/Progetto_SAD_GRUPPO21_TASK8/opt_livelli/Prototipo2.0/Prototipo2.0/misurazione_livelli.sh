...
filename="/app/Prototipo2.0/Prototipo2.0/invio.txt"
...
for var in "$@"; do
	...
	mkdir -p /repository/$NOME_CLASSE/RobotTest/EvoSuiteTest/0${cont}Level/TestReport
	mv evosuite-report/statistics.csv /repository/$NOME_CLASSE/RobotTest/EvoSuiteTest/0${cont}Level/TestReport
	mkdir -p /repository/$NOME_CLASSE/RobotTest/EvoSuiteTest/0${cont}Level/TestSourceCode
	mv I${var}/evosuite-tests/$NOME_PACKAGE /repository/$NOME_CLASSE/RobotTest/EvoSuiteTest/0${cont}Level/TestSourceCode
