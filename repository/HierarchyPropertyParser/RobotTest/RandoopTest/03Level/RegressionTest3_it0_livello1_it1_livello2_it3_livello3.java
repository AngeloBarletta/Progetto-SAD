...
public class RegressionTest3 {
  ...
  public void test107() throws Throwable {
    ...
    HierarchyPropertyParser hierarchyPropertyParser0 = new HierarchyPropertyParser();
    java.lang.String str1 = hierarchyPropertyParser0.showTree();
    boolean b3 = hierarchyPropertyParser0.goToChild("null(0)[null]\n(0)[null]\n");
    java.util.Vector vector4 = null;
    int i6 = hierarchyPropertyParser0.search(vector4, "hi!(0)[null]\n");
    
    // Regression assertion (captures the current behavior of the code)
    org.junit.Assert.assertTrue("'" + str1 + "' != '" + "null(0)[null]\n"+ "'", str1.equals("null(0)[null]\n"));
  ...
  public void test203() throws Throwable {
    ...
    // The following exception was thrown during execution in test generation
    try {
    boolean b20 = hierarchyPropertyParser2.goTo("null(0)[null]\n(0)[null]\n");
      org.junit.Assert.fail("Expected exception of type java.lang.NullPointerException");
    } catch (java.lang.NullPointerException e) {
      // Expected exception.
      if (! e.getClass().getCanonicalName().equals("java.lang.NullPointerException")) {
  ...
  public void test324() throws Throwable {
    ...
    boolean b18 = hierarchyPropertyParser2.contains("null(0)[null]\n(0)[null]\n");
    java.util.Vector vector19 = null;
    int i21 = hierarchyPropertyParser2.search(vector19, "hi!");
